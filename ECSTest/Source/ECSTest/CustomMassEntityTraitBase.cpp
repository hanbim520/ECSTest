...
// 	FSharedStruct ParamsFragment = EntitySubsystem->GetOrCreateSharedFragment<FMassRepresentationParameters>(ParamsHash, Params);
// 	ParamsFragment.Get<FMassRepresentationParameters>().ComputeCachedValues();
// 	BuildContext.AddSharedFragment(ParamsFragment);
